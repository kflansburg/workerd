...
const rustWasmExample :Workerd.Config = (
  ...
  services = [ (name = "main", worker = .rustWasm) ],
...
const rustWasm :Workerd.Worker = (
  modules = [(name="main", wasm= embed "./target/wasm32-unknown-unknown/release/rust_wasm.wasm")]
